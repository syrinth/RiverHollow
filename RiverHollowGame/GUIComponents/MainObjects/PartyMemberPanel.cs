...
//                AssignStatText(_gStr, "Str", _character.Attribute(AttributeEnum.Strength), _character.AttributeTemp(AttributeEnum.Strength), compareTemp);
//                AssignStatText(_gDef, "Def", _character.Attribute(AttributeEnum.Defence), _character.AttributeTemp(AttributeEnum.Defence), compareTemp);
//                AssignStatText(_gMagic, "Mag", _character.Attribute(AttributeEnum.Magic), _character.AttributeTemp(AttributeEnum.Magic), compareTemp);
//                AssignStatText(_gRes, "Res", _character.Attribute(AttributeEnum.Resistance), _character.AttributeTemp(AttributeEnum.Resistance), compareTemp);
//                AssignStatText(_gSpd, "Spd", _character.Attribute(AttributeEnum.Speed), _character.AttributeTemp(AttributeEnum.Speed), compareTemp);
//            }
