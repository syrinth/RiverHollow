...
namespace RiverHollow.GUIComponents.GUIObjects
{
    public class GUIButton : GUIObject
    {
        ...
        public GUIButton(string text, int width, int height, EmptyDelegate del = null)
        {
            _gWindow = new GUIWindow(BaseBtn, width, height);
            LoadWindowButton(text, width, height, del);
        }

        public void LoadWindowButton(string text, int width, int height, EmptyDelegate del)
        {
            Width = width;
            Height = height;
        ...
        public GUIButton(Rectangle sourceRect, string texture, EmptyDelegate del = null) :this(sourceRect, ScaleIt(sourceRect.Width), ScaleIt(sourceRect.Height), texture, del) { }
        public GUIButton(Rectangle sourceRect, int width, int height, string texture, EmptyDelegate del = null)
        {
            Width = width;
            Height = height;
