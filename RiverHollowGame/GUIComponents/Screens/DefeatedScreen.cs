...
namespace RiverHollow.GUIComponents.Screens
{
    internal class DefeatedScreen : GUIScreen
    {
        ...
        public DefeatedScreen()
        {
            ...
            GUIWindow win = new GUIWindow(GUIUtils.WINDOW_BROWN, GUIManager.MAIN_COMPONENT_WIDTH, GUIManager.MAIN_COMPONENT_HEIGHT);
            win.CenterOnScreen();
        ...
        private void BtnOk()
        {
            ...
            RHMap homeMap = MapManager.Maps[TownManager.Home.InnerMapName];
