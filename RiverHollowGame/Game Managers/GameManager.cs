...
namespace RiverHollow.Game_Managers
{
    public static class GameManager
    {
        ...
        public enum ObjectTypeEnum { WorldObject, BeeHive, Building, CombatHazard, Container, Destructible, DungeonObject, Floor, Gatherable, Garden, Light, Machine, Mailbox, Plant, Structure, StructureUpgrader, Wall, WarpPoint };
