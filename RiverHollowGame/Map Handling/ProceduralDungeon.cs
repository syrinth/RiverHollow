...
//            if (map2 == null || map2.TravelPoints.ContainsKey(map1.Name))
//            {
//                return;
//            }
...
//            TravelPoint positionPoint = map1._diTravelPoints[Util.GetEnumString(movementDir)];
//            TravelPoint linkedPoint = map2._diTravelPoints[Util.GetEnumString(oppDir)];
...
//            map1._diTravelPoints[positionPoint.MapLink] = positionPoint;

//            map2.DictionaryTravelPoints.Remove(Util.GetEnumString(oppDir));
//            map2._diTravelPoints[linkedPoint.MapLink] = linkedPoint;
...
//            {
//                RHMap m = map.Map;
//                Dictionary<string, TravelPoint> travlCpy = new Dictionary<string, TravelPoint>(m._diTravelPoints);
//                foreach (KeyValuePair<string, TravelPoint> kvp in travlCpy)
//                {
//                    if (kvp.Value.Modular)
//                    {
//                        TravelPoint pt = m._diTravelPoints[kvp.Key];
//                        pt.Reset();

//                        m.DictionaryTravelPoints.Remove(kvp.Key);
//                        m._diTravelPoints[Util.GetEnumString(pt.EntranceDir)] = pt;
//                    }
//                }
